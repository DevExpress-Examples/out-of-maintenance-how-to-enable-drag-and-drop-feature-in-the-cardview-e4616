...
namespace DXSample.DragDropExtension {
    public class CardDragDropManager : DragDropManagerBase {
        ...
        List<object> GetSelectedRowsCopy() {
            return new List<object>(CardView.SelectedRows.Cast<object>());
        }
        ...
        void PerformDropToViewCore(DragDropManagerBase sourceManager) {
            ...
            PerformDropToView(sourceManager, hitInfo as CardViewHitInfo, LastPosition, SetReorderDropInfo, SetMoveToGroupRowDropInfo, SetAddRowsDropInfo);
        }
        void PerformDropToView(DragDropManagerBase sourceManager, CardViewHitInfo hitInfo, Point pt, MoveRowsDelegate reorderDelegate, MoveRowsDelegate moveToGroupDelegate, MoveRowsDelegate addRowsDelegate) {
