...
#End Region
        ...
        End Function
            ...
            Private Sub SetReorderDropInfo(ByVal sourceManager As DragDropManagerBase, ByVal insertRowHandle As Integer, ByVal hitElement As DependencyObject)
                ...
                Dim dropTargetType As DropTargetType = If(dragIndicatorPosition = TableDragIndicatorPosition.Bottom, DevExpress.Xpf.Grid.DropTargetType.InsertRowsAfter, DevExpress.Xpf.Grid.DropTargetType.InsertRowsBefore)
